        ...
        <PageLayout>
            <div className="max-w-4xl mx-auto space-y-8">
                ...
                <div className="text-center space-y-4">
                    <h1 className="text-4xl md:text-5xl font-orbitron font-bold text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 to-amber-600 drop-shadow-md">
                        RANK HIERARCHY
                    </h1>
                ...
                <motion.div
                    ...
                    className="glass-panel p-8 text-center border-l-4 border-l-neon-cyan relative overflow-hidden"
                >
                    <div className="absolute top-0 right-0 p-4 opacity-10">
                        <Trophy size={120} />
                    </div>

                    <h2 className="text-xl text-gray-400 font-orbitron mb-2">CURRENT CLEARANCE</h2>
                    <div className={clsx("text-4xl font-bold font-orbitron mb-4", currentRank.color)}>
                        {currentRank.title}
                    </div>
                    ...
                    {RANKS.map((rank, index) => {
                        ...
                        return (
                            <motion.div
                                ...
                                className={clsx(
                                    "flex items-center gap-6 p-6 rounded-lg border transition-all duration-300 relative overflow-hidden",
                                    isUnlocked
                            ...
                            >
                                {/* Level Badge */}
                                <div className={clsx(
                                    "w-16 h-16 rounded-full flex items-center justify-center font-bold font-orbitron text-xl border-2 shrink-0 z-10 bg-deep-space",
                                ...
                                <div className="flex-1 z-10">
                                    ...
                                    {isNext && (
                                        <div className="text-sm text-yellow-500 mt-1 flex items-center gap-2">
                                            <Target size={14} /> NEXT PROMOTION OBJECTIVE
                                        </div>
                                    )}
                                </div>
                                ...
                                <div className="z-10">
                                    {isUnlocked ? (
                                        <Medal className={rank.color} size={32} />
                                    ) : (
